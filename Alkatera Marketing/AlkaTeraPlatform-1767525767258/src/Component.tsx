...
import { 
  ...
  Database, Cpu, TrendingUp, 
  Footprints, User, FileCheck, Network,
  Layers, BarChart, Globe, ShieldCheck,
  Microscope, Calculator, Compass
} from 'lucide-react';
...
export function AlkaTeraPlatform() {
  return (
...
export default AlkaTeraPlatform;
