  ...
  return (
    <div className="bg-[#ECEAE3] min-h-screen w-full text-[#1A1B1D] selection:bg-[#1A1B1D] selection:text-[#F2F1EA] overflow-x-hidden">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-40 pb-24">
        <h1 className="font-display font-bold tracking-[-0.035em] text-4xl md:text-5xl mb-4">Cookie policy.</h1>
        ...
        <div className="prose prose-neutral max-w-none space-y-8 text-[#1A1B1D]/80 leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">1. What Are Cookies?</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">2. How We Use Cookies</h2>

            <h3 className="font-display text-lg font-medium text-[#1A1B1D] mt-6 mb-3">2.1 Strictly Necessary Cookies</h3>
            ...
            <h3 className="font-display text-lg font-medium text-[#1A1B1D] mt-6 mb-3">2.2 Functional Cookies</h3>
            ...
            <h3 className="font-display text-lg font-medium text-[#1A1B1D] mt-6 mb-3">2.3 Analytics Cookies</h3>
            ...
            <h3 className="font-display text-lg font-medium text-[#1A1B1D] mt-6 mb-3">2.4 Marketing Cookies</h3>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">3. Cookies We Use</h2>

            <div className="overflow-x-auto">
              <table className="w-full text-sm border border-[#D9D6CB] mt-4">
                <thead>
                  <tr className="border-b border-[#D9D6CB] text-left bg-[#F2F1EA]">
                    <th className="p-3 text-[#1A1B1D] font-medium">Cookie</th>
                    <th className="p-3 text-[#1A1B1D] font-medium">Purpose</th>
                    <th className="p-3 text-[#1A1B1D] font-medium">Duration</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#D9D6CB]/60">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">4. Third-Party Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">5. Managing Cookies</h2>
            <p>You can control cookies through:</p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-[#1A1B1D]">Cookie Consent Banner:</strong> When you first visit our site, you can choose which optional cookies to accept</li>
              <li><strong className="text-[#1A1B1D]">Browser Settings:</strong> Most browsers allow you to refuse or delete cookies through settings</li>
              <li><strong className="text-[#1A1B1D]">Platform Settings:</strong> Logged-in users can manage preferences in account settings</li>
            </ul>
            <p>Note that blocking some cookies may impact your experience and the functionality available to you.</p>
          </section>

          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">6. Browser-Specific Instructions</h2>
            <p>To manage cookies in your browser:</p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-[#1A1B1D]">Chrome:</strong> Settings &gt; Privacy and Security &gt; Cookies</li>
              <li><strong className="text-[#1A1B1D]">Firefox:</strong> Options &gt; Privacy &amp; Security &gt; Cookies</li>
              <li><strong className="text-[#1A1B1D]">Safari:</strong> Preferences &gt; Privacy &gt; Cookies</li>
              <li><strong className="text-[#1A1B1D]">Edge:</strong> Settings &gt; Privacy &amp; Services &gt; Cookies</li>
            </ul>
          </section>

          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">7. Similar Technologies</h2>
            <p>We may also use similar technologies including:</p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong className="text-[#1A1B1D]">Local Storage:</strong> For storing data locally in your browser</li>
              <li><strong className="text-[#1A1B1D]">Session Storage:</strong> For temporary storage during a session</li>
              <li><strong className="text-[#1A1B1D]">Pixel Tags:</strong> Small graphics to track user behaviour</li>
            </ul>
          </section>

          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">8. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-[#1A1B1D] mt-10 mb-4">9. Contact Us</h2>
