/*
  # Platform Admin System - Simplified Version

  Since all existing organizations have NULL subscription_tier,
  we can safely update the constraint without data conflicts.
*/

-- =====================================================
-- STEP 1: ADD PLATFORM ADMIN FLAG (if not exists)
-- =====================================================
...
-- =====================================================
-- STEP 2: UPDATE CONSTRAINT TO ALLOW NULL + NEW TIERS
-- =====================================================
...
-- Create new constraint allowing NULL and the three AlkaTera tiers
ALTER TABLE organizations
