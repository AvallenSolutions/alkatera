/*
  # Platform Admin System - Independent of Subscription Tiers (FIXED)

  ## Overview
  Creates a dedicated platform admin organization that bypasses subscription
  tier constraints. Platform admins can manage the entire AlkaTera platform.

  ## What This Creates
  - Adds `is_platform_admin` flag to organizations table
  - Updates subscription tier constraint to allow platform admins
...
-- Recreate it to allow NULL for platform admin orgs
ALTER TABLE organizations
ADD CONSTRAINT valid_subscription_tier
CHECK (
  -- Platform admin orgs can have any tier or NULL
  is_platform_admin = true
  OR
  -- Regular orgs must have valid tiers
...
-- Using NULL for subscription_tier since platform admin orgs are exempt
