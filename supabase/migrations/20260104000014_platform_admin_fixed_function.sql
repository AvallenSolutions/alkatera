/*
  # Platform Admin System - Fixed Ambiguous Column References

  Fixes the "column reference is ambiguous" error in add_platform_admin function
*/
...
-- =====================================================
-- STEP 5: HELPER FUNCTIONS (with fixed column references)
-- =====================================================
...
BEGIN
  ...
  -- Add user to platform admin org (fixed ambiguous column references)
...
BEGIN
  ...
  WHERE organization_members.organization_id = v_org_id
