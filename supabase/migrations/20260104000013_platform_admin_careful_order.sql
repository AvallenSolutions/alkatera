/*
  # Platform Admin System - Careful Order of Operations

  Current constraint: subscription_tier IN ('seed', 'blossom', 'canopy')
  Problem: Does not allow NULL values
  Solution: Drop constraint FIRST, then add column, then recreate with NULL support
*/

-- =====================================================
-- STEP 1: DROP OLD CONSTRAINT (before adding column)
-- =====================================================
...
-- =====================================================
-- STEP 2: ADD PLATFORM ADMIN FLAG
-- =====================================================
...
-- =====================================================
-- STEP 3: CREATE NEW CONSTRAINT (allows NULL)
-- =====================================================
...
-- Create AlkaTera platform admin organization (with NULL tier)
...
-- =====================================================
-- STEP 6: UPDATE is_alkatera_admin() FUNCTION
-- =====================================================
