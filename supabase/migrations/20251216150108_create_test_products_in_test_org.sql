/*
  # Create Test Products in Test Organisation

  This migration creates comprehensive test data for three products in the Test organisation
  with full environmental impact coverage.

  ## 1. New Facilities (Test Org)
    - Test Distillery (Normandy, France) - Third party
    - Test Brewery (Oxford, UK) - Owned
    - Test Winery (Central Otago, NZ) - Owned
    - Test Bottling Plant (Christchurch, NZ) - Third party

  ## 2. New Products (Test Org)
    - TEST CALVADOS - Apple brandy from Normandy
    - TEST NON-ALC BEER - Non-alcoholic beer from Oxford
    - TEST WINE - Pinot Noir from Central Otago

  ## 3. Complete Impact Data
    - GHG emissions with fossil/biogenic breakdown
