/*
  # Fix Gaia Corporate Emissions RPC Function

  ## Issue
  The previous migration used incorrect column names:
  - `reporting_year` should be `year` in corporate_reports
  - `source_id` should be `emission_source_id` in facility_activity_data
