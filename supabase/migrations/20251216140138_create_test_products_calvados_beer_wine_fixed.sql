/*
  # Create Test Products: Calvados, Non-Alcoholic Beer, and Wine

  This migration creates comprehensive test data for three products with full environmental 
  impact coverage including GHG emissions, water impact, circularity, and land/biodiversity.

  ## 1. New Facilities
    - Test Distillery (Normandy, France) - Third party for Calvados
    - Test Brewery (Oxford, UK) - Owned for Non-Alc Beer
    - Test Winery (Central Otago, NZ) - Owned for Wine
    - Test Bottling Plant (Christchurch, NZ) - Third party for Wine

  ## 2. New Products
    - TEST CALVADOS - Apple brandy from Normandy
    - TEST NON-ALC BEER - Non-alcoholic beer brewed in Oxford
    - TEST WINE - Pinot Noir from Central Otago

  ## 3. Product Materials
    - Ingredients for each product with environmental impact data
    - Packaging components with circularity metrics

  ## 4. Environmental Impact Data
    - GHG emissions (climate change impact)
    - Water consumption and scarcity
    - Land use and biodiversity impact
    - Waste generation and circularity metrics
*/

DO $$
DECLARE
  v_org_id UUID := 'ad85332e-9c9e-492f-95b8-59d5b0eb572a';
...
BEGIN
  ...
  -- PRODUCT MATERIALS (template for product)
  -- Calvados materials
  ...
  INSERT INTO product_materials (product_id, material_name, material_type, quantity, unit, lca_stage_id, lca_sub_stage_id, packaging_category, notes)
  VALUES (v_beer_id, 'Aluminium Can 330ml (direct print)', 'packaging', 0.015, 'kg', 1, 3, 'container', '330ml aluminium can with direct printing, no separate label');
  ...
  VALUES (v_wine_id, 'Green Glass Bottle 750ml (80% recycled)', 'packaging', 0.500, 'kg', 1, 3, 'container', '750ml green glass bottle, 80% recycled glass content',
  ...
  INSERT INTO product_materials (product_id, material_name, material_type, quantity, unit, lca_stage_id, lca_sub_stage_id, packaging_category, notes)
  VALUES (v_wine_id, 'Foil Capsule', 'packaging', 0.003, 'kg', 1, 3, 'closure', 'Aluminium foil wrapper/capsule');

  -- LCA MATERIALS WITH IMPACT DATA (using 'name' column)
  -- Calvados LCA materials
  ...
  VALUES (v_calvados_lca_id, 'Process Water', 'Process Water', 'ingredient', 2.0, 'L', 1, 'France',
    ...
    2, 'Regional_Standard', 90, 'ReCiPe 2016 Midpoint (H)', 'Ecoinvent 3.12 - Tap water production FR');
  ...
  VALUES (v_calvados_lca_id, 'Glass Bottle 700ml (65% recycled)', 'Glass Bottle 700ml (65% recycled)', 'packaging', 0.480, 'kg', 3, 'container',
    ...
    2, 'Regional_Standard', 80, 'ReCiPe 2016 Midpoint (H)', 'Ecoinvent 3.12 - Glass bottle 65% recycled content');
  ...
  VALUES (v_beer_lca_id, 'Aluminium Can 330ml', 'Aluminium Can 330ml (direct print)', 'packaging', 0.015, 'kg', 3, 'container',
    ...
    2, 'Regional_Standard', 85, 'ReCiPe 2016 Midpoint (H)', 'Ecoinvent 3.12 - Aluminium can, 60% recycled content');
  ...
  VALUES (v_wine_lca_id, 'Pinot Noir Grapes', 'Pinot Noir Grapes', 'ingredient', 1.2, 'kg', 1, 'New Zealand',
    ...
    1, 'Primary_Verified', 90, 'ReCiPe 2016 Midpoint (H)', 'Ecoinvent 3.12 - Grape production, vineyard NZ', 'NZ',
    'truck', 5, 0.00005);
  ...
  VALUES (v_wine_lca_id, 'Green Glass Bottle 750ml', 'Green Glass Bottle 750ml (80% recycled)', 'packaging', 0.500, 'kg', 3, 'container',
    ...
    2, 'Regional_Standard', 80, 'ReCiPe 2016 Midpoint (H)', 'Ecoinvent 3.12 - Glass bottle 80% recycled content',
    'truck', 100, 0.0045);
  ...
  VALUES (v_wine_lca_id, 'Paper Label', 'Paper Label', 'packaging', 0.004, 'kg', 3, 'label',
    ...
    3, 'Secondary_Modelled', 70, 'ReCiPe 2016 Midpoint (H)', 'Ecoinvent 3.12 - Paper label production');
  ...
  VALUES (v_wine_lca_id, 'Traditional Cork', 'Traditional Cork', 'packaging', 0.004, 'kg', 3, 'closure',
    ...
    2, 'Regional_Standard', 75, 'ReCiPe 2016 Midpoint (H)', 'Ecoinvent 3.12 - Natural cork stopper');
  ...
  VALUES (v_wine_lca_id, 'Foil Capsule', 'Foil Capsule', 'packaging', 0.003, 'kg', 3, 'closure',
    ...
    3, 'Secondary_Modelled', 70, 'ReCiPe 2016 Midpoint (H)', 'Ecoinvent 3.12 - Aluminium foil production');

  -- PRODUCTION SITE LINKS
