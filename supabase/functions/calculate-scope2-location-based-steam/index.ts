...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (!emissionsFactor) {
      return new Response(
        JSON.stringify({ 
          error: `No Scope 2 Location-Based Steam emissions factor found for region: ${activity_data.grid_region}`,
    ...
    return new Response(
      JSON.stringify({
        ...
        metadata: {
          ...
          calculation_type: "Scope 2: Location-Based - Steam",
        },
      }),
      {
        status: 200,
