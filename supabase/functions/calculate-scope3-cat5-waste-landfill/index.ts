...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (!emissionsFactor) {
      return new Response(
        JSON.stringify({ 
          error: `No Scope 3 Category 5 landfill emissions factor found for waste type: ${activity_data.waste_type}`,
    ...
    return new Response(
      JSON.stringify({
        ...
        metadata: {
          ...
          calculation_type: "Scope 3: Category 5 - Waste Generated in Operations - Landfill",
        },
      }),
      {
        status: 200,
