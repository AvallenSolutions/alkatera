    ...
    materials: [
      {
        ...
        label: 'Glass',
        eolKey: 'glass',
        efSearchQuery: 'packaging glass bottle',
      ...
      },
      {
        ...
        label: 'Plastic (PET)',
        eolKey: 'pet',
        efSearchQuery: 'packaging PET bottle',
      ...
      },
      {
        ...
        label: 'Plastic (HDPE)',
        eolKey: 'hdpe',
        efSearchQuery: 'packaging HDPE bottle',
    ...
    materials: [
      {
        ...
        label: 'Aluminium',
        eolKey: 'aluminium',
        efSearchQuery: 'packaging aluminium can',
      ...
      },
      {
        ...
        label: 'Steel',
        eolKey: 'steel',
        efSearchQuery: 'packaging steel can tinplate',
    ...
    materials: [
      {
        ...
        eolKey: 'steel',
        efSearchQuery: 'packaging stainless steel keg',
      ...
      },
      {
        ...
        eolKey: 'pet',
        efSearchQuery: 'packaging PET keg',
    ...
    materials: [
      {
        ...
        eolKey: 'paper',
        efSearchQuery: 'packaging beverage carton liquid packaging board',
    ...
    materials: [
      {
        ...
        eolKey: 'pet',
        efSearchQuery: 'packaging plastic film laminate pouch',
    ...
    materials: [
      {
        ...
        eolKey: 'paper',
        efSearchQuery: 'packaging bag-in-box corrugated board',
...
export const CLOSURE_OPTIONS: AccessoryOption[] = [
  {
    ...
    eolKey: 'steel',
    materialKey: 'steel',
    efSearchQuery: 'packaging steel crown cap',
  ...
  },
  {
    ...
    efSearchQuery: 'packaging aluminium screw cap closure',
  ...
  },
  {
    ...
    eolKey: 'pet',
    materialKey: 'pet',
    efSearchQuery: 'packaging plastic closure cap HDPE',
  ...
  },
  {
    ...
    eolKey: 'cork',
    materialKey: 'cork',
    efSearchQuery: 'packaging natural cork stopper',
    typicalWeightG: { medianG: 5, minG: 3, maxG: 10 },
...
export const LABEL_OPTIONS: AccessoryOption[] = [
  {
    ...
    eolKey: 'paper',
    materialKey: 'paper',
    efSearchQuery: 'packaging paper label',
  ...
  },
  {
    ...
    eolKey: 'pet',
    materialKey: 'pet',
    efSearchQuery: 'packaging plastic film label',
...
export const MULTIPACK_OPTIONS: AccessoryOption[] = [
  {
    ...
    efSearchQuery: 'packaging carton board multipack',
  ...
  {
    key: 'cardboard_case',
    label: 'Cardboard case or box',
    formats: [],
    eolKey: 'paper',
    materialKey: 'paperboard',
    efSearchQuery: 'packaging corrugated board box',
  ...
  },
  {
    ...
    eolKey: 'pet',
    materialKey: 'pet',
    efSearchQuery: 'packaging LDPE shrink film',
