// Studio email kit. One wrapper, one palette, so every email the platform
// sends reads as the same house: ink on paper, mono eyebrows, forest accent,
// hairline rules. The edge-function twin is
// supabase/functions/_shared/studio-email.ts; keep the two in step.
