...
/** Renders the full colour alkatera logo as an <img> element */
function alkateraLogo(height: number): string {
  return `<img src="${ALKATERA_LOGO_URL}" alt="alkatera" style="height: ${height}px; width: auto; object-fit: contain;" />`;
}
...
function renderGoalAndScopePage(data: LCAReportData): string {
  ...
  return `
    <div class="page light-page">
      ...
      <div style="font-size: 9px; font-family: 'Fira Code', monospace; color: #78716c; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 6px;">ISO 14044:2006 &sect;4.2</div>
    ...
    <div class="page dark-page" style="justify-content: center; text-align: center;">
      <div style="max-width: 500px; margin: 0 auto;">
        ...
        <div style="margin-top: 64px; padding-top: 32px; border-top: 1px solid rgba(255,255,255,0.1);">
          ...
          <a href="https://app.alkatera.com" style="display: inline-block; margin-top: 16px; color: #ccff00; font-size: 12px; font-family: 'Fira Code', monospace; text-decoration: none; letter-spacing: 1px; padding: 8px 20px; border: 1px solid rgba(204,255,0,0.3); border-radius: 6px;">
            app.alkatera.com
          </a>
        </div>
      </div>
