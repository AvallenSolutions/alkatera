 ...
 * small, curated, read-only view. The full draggable grid still exists
 * behind the "Customise" toggle (see PulseGrid).
 *
 * The curated experience is the themed tab set in lib/pulse/tabs.ts.
 */

/** The curated tabbed experience, or the full customisable grid. */
export type PulseView = 'tabs' | 'advanced';

export const DEFAULT_VIEW: PulseView = 'tabs';
