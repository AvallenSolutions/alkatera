...
- **Not done yet**: Phase 4 Rosa sync into `gaia_knowledge_base`; quarterly legislation review (due early October 2026); nav placement beyond the /knowledge cross-link.
