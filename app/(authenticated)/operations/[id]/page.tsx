...
const UTILITY_TYPES = [
  ...
  { value: 'refrigerant_leakage', label: 'Refrigerants', defaultUnit: 'kg' },
];
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="data-entry" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
              <CardTitle>Log Facility Meter Reading</CardTitle>
              <CardDescription>
                Enter energy or water usage for this specific site
              </CardDescription>
            </CardHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Unit is automatically set based on utility type
                  </p>
                </div>
