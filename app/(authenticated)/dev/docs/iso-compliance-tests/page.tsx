...
const markdownContent = `# ISO Compliance Testing Results - Phase 2 LCA Enhancements
...
export default function ISOComplianceTestsPage() {
  return (
    <MarkdownDoc
      title="ISO Compliance Testing Results"
      description="Comprehensive testing results for Phase 2 LCA enhancements covering hybrid data model, data quality tracking, and ISO compliance"
      content={markdownContent}
      badge="Phase 2 - All Tests Passed"
    />
  );
}
