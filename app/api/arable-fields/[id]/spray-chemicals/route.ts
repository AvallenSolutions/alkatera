...
/**
 * GET /api/arable-fields/[id]/spray-chemicals?growing_profile_id=XXX
 *
...
export async function GET(
  ...
  try {
    ...
    if (error) {
      console.error('[ArableSprayChemicals GET] Query error:', error);
      return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
    }

    return NextResponse.json({ data: data || [] });
  } catch (err: any) {
    console.error('[ArableSprayChemicals GET] Error:', err);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}

/**
 * POST /api/arable-fields/[id]/spray-chemicals
 *
 ...
 *   chemicals: ArableSprayChemicalDraft[]
 */
export async function POST(
  ...
  try {
    ...
    if (deleteError) {
      console.error('[ArableSprayChemicals POST] Delete error:', deleteError);
      return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
    }
    ...
    if (error) {
      console.error('[ArableSprayChemicals POST] Insert error:', error);
      return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
    }

    return NextResponse.json({ success: true, data }, { status: 201 });
  } catch (err: any) {
    console.error('[ArableSprayChemicals POST] Error:', err);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}

/**
 * DELETE /api/arable-fields/[id]/spray-chemicals?growing_profile_id=XXX
 *
...
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      console.error('[ArableSprayChemicals DELETE] Error:', error);
      return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
    }

    return NextResponse.json({ success: true });
  } catch (err: any) {
    console.error('[ArableSprayChemicals DELETE] Error:', err);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
