...
import { IntakeTabs } from '@/components/admin/directory/intake-tabs';
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl">
              Three ways to get brands in. A generation brief lets the model search the web for
              you. Pasting a list adds names or URLs straight away. CSV upload is for curated
              spreadsheets. Every new entry lands as <strong>pending</strong> for your review.
            </p>
          </div>
        </div>
      </div>
