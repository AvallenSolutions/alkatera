        ...
        {isLoading ? (
          ...
          <>
            ...
            <Alert className="bg-violet-50 dark:bg-violet-950/30 border-violet-200 dark:border-violet-800">
              ...
              <AlertDescription className="text-xs text-violet-800 dark:text-violet-200">
                Calculated from material origins in your Product LCAs. To update, edit transport details on your products.
              </AlertDescription>
            </Alert>
          </>
        ) : (
          <div className="py-8 text-center">
            ...
            <p className="text-xs text-muted-foreground max-w-xs mx-auto">
              Add material origins and transport modes to your Product LCAs to automatically calculate upstream transport emissions.
            </p>
          </div>
        )}
      </CardContent>
