                        ...
                        <TableCell colSpan={9} className="bg-muted/30 p-0">
                          <div className="px-6 py-4 grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-3 text-xs">
                            ...
                            <div className="space-y-1.5">
                              <p className="font-semibold text-muted-foreground uppercase tracking-wider text-[10px]">FLAG Emissions</p>
                            ...
                            {/* Column 4: Normalised */}
                            <div className="space-y-1.5">
                              <p className="font-semibold text-muted-foreground uppercase tracking-wider text-[10px]">Per kg Grain</p>
