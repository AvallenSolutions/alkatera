      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="flex items-center gap-2 text-sm">
            ...
            FLAG Emissions Breakdown (per ha)
          </CardTitle>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={n2oBreakdownData} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
              ...
              <Bar dataKey={`Lime CO\u2082`} stackId="1" fill={COLOURS.purple} radius={[4, 4, 0, 0]} maxBarSize={40} />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={250}>
            <AreaChart data={waterData} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
              <defs>
                <linearGradient id="gradWaterArable" x1="0" y1="0" x2="0" y2="1">
              ...
              <Legend iconType="circle" iconSize={8} wrapperStyle={{ fontSize: '11px', paddingTop: '8px' }} />
              <Area type="monotone" dataKey="water_per_ha" name="Volume" stroke={COLOURS.blue} fill="url(#gradWaterArable)" strokeWidth={2} dot={{ r: 3, fill: COLOURS.blue }} />
